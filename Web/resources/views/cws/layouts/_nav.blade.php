    ...
    <div data-simplebar class="sidebar-menu-scroll">
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled mt-3" id="side-menu">
                ...
                <li class="{{request()->route()->getName() == 'cws.dashboard' ? 'mm-active' : ''}}">
                    <a href="{{route('cws.dashboard')}}" class="{{request()->route()->getName() == 'cws.dashboard' ? 'active' : ''}}">
                        <svg class="icon nav-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-speedometer2" viewBox="0 0 16 16">
        ...
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled mt-3" id="side-menu">
                ...
                <li>
                    <a href="{{route('cws.setting')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear  font-size-16 align-middle me-2" viewBox="0 0 16 16">
